/*************************************************************************
    > File Name: sem_somename.c
    > Author: King
    > Mail: arturiapendragon_1@163.com 
    > Created Time: 2017年12月24日 星期日 17时33分21秒
 ************************************************************************/
...
int main(int argc, char *argv[])
{
	...
	pthread_t tid_produce;			//生产者线程id
	pthread_t tid_consume;			//消费者线程id
	...
	pthread_setconcurrency(2);					//设置当前并发度
